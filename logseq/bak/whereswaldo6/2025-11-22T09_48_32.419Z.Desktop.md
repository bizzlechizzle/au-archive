...
|------|--------|-------------|
| `src/stores/import-store.ts` | CREATE | Global import state management |
| `src/components/ImportProgress.svelte` | CREATE | Floating progress indicator |
| `src/App.svelte` | MODIFY | Add progress listener |
| `src/pages/LocationDetail.svelte` | MODIFY | Fire-and-forget import |
| `src/pages/Dashboard.svelte` | MODIFY | Add import status widget |
...
| **6** | **Import UX - blocking, no progress** | IN PROGRESS |
